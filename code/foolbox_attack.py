...
def main(argv):
    ...
    if FLAGS.package == 'advertorch':
        ...
        with open(os.path.join(OUTPUT_PATH, NAME+'.mtb'), 'wb') as file:
            ...
            succ_prob = foolbox_upper_bound(model, val_subset_loader, FLAGS.attack_size, clip_fn=clip_fn, a=FLAGS.a, b=FLAGS.b, stride=FLAGS.stride, max_iter=FLAGS.nb_iter, eps=FLAGS.eps, stepsize=FLAGS.stepsize, return_early=FLAGS.return_early)
