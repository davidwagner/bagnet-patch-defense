...
#sudo python3 foolbox_attack.py -N=500 -model=resnet101 -clip_fn=None -attack_alg=AdamRandomPGD -nb_iter=80 -stepsize=0.1 -data_path=/home/zhanyuan/data/imagenet -output_root=/home/zhanyuan/data/results/foolbox_results
#################################################################
...
###############################################################
#sudo python3 foolbox_attack.py -N=500 -stride=40 -model=bagnet17 -clip_fn=tanh_linear -attack_alg=AdamRandomPGD -nb_iter=40 -stepsize=0.1 -data_path=/home/zhanyuan/data/imagenet -output_root=/home/zhanyuan/data/results/foolbox_results
...
# AdamRandomPGD + CW objective
##########################################################
sudo python3 foolbox_attack.py -N=500 -model=resnet50 -clip_fn=None -attack_alg=AdamRandomPGD -targeted=True -nb_iter=80 -stepsize=0.1 -data_path=/home/zhanyuan/data/imagenet -output_root=/home/zhanyuan/data/results/foolbox_results
sudo python3 foolbox_attack.py -N=500 -model=resnet101 -clip_fn=None -attack_alg=AdamRandomPGD -targeted=True -nb_iter=40 -stepsize=0.1 -data_path=/home/zhanyuan/data/imagenet -output_root=/home/zhanyuan/data/results/foolbox_results
sudo python3 foolbox_attack.py -N=500 -model=resnet101 -clip_fn=None -attack_alg=AdamRandomPGD -targeted=True -nb_iter=80 -stepsize=0.1 -data_path=/home/zhanyuan/data/imagenet -output_root=/home/zhanyuan/data/results/foolbox_results
sudo python3 foolbox_attack.py -N=500 -model=densenet -clip_fn=None -attack_alg=AdamRandomPGD -targeted=True -nb_iter=80 -stepsize=0.1 -data_path=/home/zhanyuan/data/imagenet -output_root=/home/zhanyuan/data/results/foolbox_results
