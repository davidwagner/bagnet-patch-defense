...
sudo python3 foolbox_attack.py -N=500 -model=bagnet33 -clip_fn=tanh_linear -attack_alg=AdamRandomPGD -targeted=True -nb_iter=80 -stepsize=0.1 -data_path=/home/zhanyuan/data/imagenet -output_root=/home/zhanyuan/data/results/foolbox_results
