...
flags.DEFINE_boolean('istop1', False, 'whether to get top1 acc')
...
def main(argv):
    ...
    FLAGS.output_root/
        [NAME]/
            ...
            dataset/
    """
    print(f'{FLAGS.N}-{FLAGS.chunkid}-{FLAGS.model}-{FLAGS.clip_fn}-{FLAGS.istop1}')
    #if FLAGS.targeted:
    ...
    if clip_fn is None and FLAGS.model in ["bagnet9", "bagnet17", "bagnet33"]:
